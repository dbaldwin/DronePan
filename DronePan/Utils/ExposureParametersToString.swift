...
extension DJICameraExposureMode {
    var description : String {
        get {
            ...
            case .Unknown: DDLogError("Exposure Mode Enum of Unknown Type!")
            }
            return text
        }
    }
...
extension DJICameraAperture {
    var description : String {
        get {
            ...
            case .F20: text += "20"
            case .F22: text += "22"
            case .Unknown: DDLogError("Aperture Enum of Unknown Type!")
            }
            return text
        }
    }
...
extension DJICameraShutterSpeed {
    var description : String {
        get {
            ...
            case .SpeedUnknown: DDLogError("Shutter Speed Enum of Unknown Type!")
            }
            text += "s"
            return text
        }
...
extension DJICameraISO {
    var description : String {
        get {
            ...
            case .ISOUnknown: DDLogError("ISO Enum of Unknown Type!")
            }
            return text
        }
    }
